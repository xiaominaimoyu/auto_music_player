...
class PlayerTab(QWidget):
    def __init__(self, db, player, player_cfg, config_path=None,
        ...
        if bool(humanize_cfg.get("enabled", True)):
    ...
    def _on_select(self):
        ...
        self.play_btn.setEnabled(not self._is_any_player_active())
    ...
    def _is_any_player_active(self) -> bool:
    ...
    def _check_focus(self):
        if not self._is_any_player_active():
            self._focus_timer.stop()
            return
